...
const NDA: React.FC<Props> = ({ lang }) => {
  ...
  return (
    <p
      className="jetbrains p-1 text-white text-nowrap text-sm rounded px-1.5 ml-1.5 select-none whitespace-nowrap cursor-help border-2 border-[#f8c476] bg-[#d28718]"
      title={getTitle()}
    >
      <svg
