...
interface Props {
  rh: keyof typeof RepoHosting;
}

const RepoProvider: React.FC<Props> = ({ rh }) => {
  const hostingType = RepoHosting[rh];
  return (
    <>
      {hostingType === RepoHosting.GitHub && (
        <div className="glassbox p-1 rounded border-solid border-2 border-[rgba(0,0,0,0.5)]">
          <svg
      ...
      {hostingType === RepoHosting.Bitbucket && (
        <div className="glassbox p-1 rounded border-solid border-2 border-[rgba(0,0,0,0.5)]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="dark:invert h-5 w-auto"
      ...
      {hostingType === RepoHosting.GitLab && (
        <div className="glassbox p-1 rounded border-solid border-2 border-[rgba(0,0,0,0.5)]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="dark:invert h-5 w-auto"
      ...
      {hostingType === RepoHosting.Codeberg && (
        <div className="glassbox p-1 rounded border-solid border-2 border-[rgba(0,0,0,0.5)]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="dark:invert h-5 w-auto"
      ...
      {hostingType === RepoHosting.Mercurial && (
        <div className="glassbox p-1 rounded border-solid border-2 border-[rgba(0,0,0,0.5)]">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="dark:invert h-5 w-auto"
