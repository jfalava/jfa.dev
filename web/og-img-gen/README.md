...
Local images stay in the browser’s IndexedDB until the user removes them or resets the project. Exporting a project creates a portable ZIP-based `.ogproj` file in the browser; nothing is sent to a remote service.
